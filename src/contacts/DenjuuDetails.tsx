...
export const DenjuuDetails = ({ denjuu }: { denjuu: PlayerDenjuu }) => {
    ...
    return <Container>
        ...
        <table>
            <StatTable>
                <tr><td><StatEntry entryColor={''}>Level</StatEntry></td><td>{denjuu.level}</td></tr>
                <tr><td><StatEntry entryColor={'#FFFF00'}>Max HP</StatEntry></td><td>{denjuu.stats.hp}</td></tr>
                <tr><td><StatEntry entryColor={'#0066FF'}>Speed</StatEntry></td><td>{denjuu.stats.speed}</td></tr>
                <tr><td><StatEntry entryColor={'#FF3300'}>Attack</StatEntry></td><td>{denjuu.stats.attack}</td></tr>
                <tr><td><StatEntry entryColor={'#33CC00'}>Defense</StatEntry></td><td>{denjuu.stats.defense}</td></tr>
                <tr><td><StatEntry entryColor={'#CC9933'}>D. Attack</StatEntry></td><td>{denjuu.stats.denmaAttack}</td></tr>
                <tr><td><StatEntry entryColor={'#33CC66'}>D. Defense</StatEntry></td><td>{denjuu.stats.denmaDefense}</td></tr>
